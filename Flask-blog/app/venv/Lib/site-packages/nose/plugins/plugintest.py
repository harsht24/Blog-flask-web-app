...
arguments and reads environment variables.
    ...
    ...             self.fanciness = 2
    ...         if 'EVEN_FANCIER' in self.venv:
    ...             self.fanciness = 3
    ... 
    ...     def options(self, parser, venv=os.environ):
    ...         self.venv = venv
    ...         parser.add_option('--more-fancy', action='store_true')
    ...         Plugin.options(self, parser, venv=venv)
    ... 
...
class PluginTester(object):
    ...
    - plugins
      ...
      - the list of plugins to make available during the run. Note
        ...
        or other settings in argv or venv will be enabled.
