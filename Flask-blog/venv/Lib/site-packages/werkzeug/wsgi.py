...
def get_current_url(
    ...
    >>> venv = create_environ("/?param=foo", "http://localhost/script")
    >>> get_current_url(venv)
    'http://localhost/script/?param=foo'
    >>> get_current_url(venv, root_only=True)
    'http://localhost/script/'
    >>> get_current_url(venv, host_only=True)
    'http://localhost/'
    >>> get_current_url(venv, strip_querystring=True)
    'http://localhost/script/'
    ...
    >>> iri_to_uri(get_current_url(venv))
    'http://localhost/script/?param=foo'
...
def pop_path_info(environ, charset="utf-8", errors="replace"):
    ...
    >>> venv = {'SCRIPT_NAME': '/foo', 'PATH_INFO': '/a/b'}
    >>> pop_path_info(venv)
    'a'
    >>> venv['SCRIPT_NAME']
    '/foo/a'
